      ...
      <form action="" method = "POST">
        <div class="user-details">
          <div class="input-box">
            ...
            <input type="number" name = "employee_number" value = "<?php echo $employee_number;?>" required/>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" name="civilstatus" value = "<?php echo $civilstatus;?>"required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" name="Quali_Depens_Status" value = "<?php echo $Quali_Depens_Status;?>" required>
          </div>
          <div class="input-box">
            <span class="details">Paydate: </span>
            <input type="date" name="paydate" value = "<?php echo $paydate;?>"required >
          </div>
          <div class="input-box">
            <span class="details">Employee Status: </span>
            <input type="text" name="employee_status" value = "<?php echo $employee_status;?>" required>
          </div>
         <div class="input-box">
             <h3>BASIC INCOME: </h3>
            <span class="details">Rate / Hour:  </span>
            <input type="number" name ="rate_per_hour_0" value = "<?php echo $rate_per_hour_0;?>"required>
          </div>
          <div class="input-box">
            <span class="details">No. of Hours/ Cut Off: </span>
            <input type="number" name = "num_of_hour_cutoff_0" value = "<?php echo $num_of_hour_cutoff_0;?>" required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="number" name="sss_contri" value="<?php echo $sss_contri;?>" required>
          </div>
          <div class="input-box">
            <span class="details">Philhealth Contribution:  </span>
            <input type="number" name="philhealth_contri" value="<?php echo $philhealth_contri;?>" required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="number" name="tax1" value="<?php echo $tax1;?>" required>
          </div>
          <div class="input-box">
             <h3>HONORARIUM INCOME:</h3>
            <span class="details">Rate / Hour: </span>
            <input type="number" name="rate_per_hour_1" value="<?php echo $rate_per_hour_1;?>"required/>
          </div>
          <div class="input-box">
            <span class="details">No. of Hours / Cut Off:  </span>
            <input type="number" name="num_of_hour_cutoff_1" value="<?php echo $num_of_hour_cutoff_1;?>"required />
          </div>
          <div class="input-box">
            <span class="details">Income / Cut Off: </span>
          ...
          <div class="input-box">
            ...
            <input type="number" name="sss_loan" value="<?php echo $sss_loan;?>"required >
          </div>
          <div class="input-box">
            <span class="details">Pag- Ibig Loan:  </span>
            <input type="number" name="pagibig_loan" value="<?php echo $pagibig_loan;?>" required >
          </div>
          <div class="input-box">
            <span class="details">Faculty Saving Deposit:  </span>
            <input type="number" name="faculty_deposit" value="<?php echo $faculty_deposit;?>" required >
          </div>
          <div class="input-box">
            <span class="details">Faculty Savings Loan:  </span>
            <input type="number" name="faculty_savings" value="<?php echo $faculty_savings;?>"required >
          </div>
          <div class="input-box">
            <span class="details">Salary Loan  </span>
            <input type="number" name="salary_loan" value="<?php echo $salary_loan;?>" required>
          </div>
          <div class="input-box">
            <span class="details">Others Loan:  </span>
             <input type="number" name="other_loans" value="<?php echo $other_loans;?>"required >
          </div>
          <div class="input-box">
            <h3>OTHER INCOME: </h3>
            <span class="details">Rate / Hour:  </span>
            <input type="number" name="rate_per_hour_2" value="<?php echo $rate_per_hour_2;?>" required/>
          </div>
          <div class="input-box">
            <span class="details">No. of Hours / Cut Off:  </span>
            <input type="number" name="num_of_hour_cutoff_2" value="<?php echo $num_of_hour_cutoff_2;?>" required/>
          </div>
          <div class="input-box">
            <span class="details">Income / Cut Off:  </span>
        ...
        <div class="button">
          <input type="submit" name = "submit" value="CALCULATE GROSS INCOME">
        </div>
        <div class="button">
        ...
        <div class="button">
          <input onclick="myfunction()" value="GO BACK TO HOME PAGE!">
          <script>
               function myfunction() {
